...
path = "forager_test/data/lexical_data/Jimmy"
if os.path.exists(path + "/semantic_embeddings.csv"): 
    print("semantic embeddings already exists")
else: 
    print("semantic embeddings does not exist")