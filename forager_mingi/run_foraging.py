...
# similaritypath =  'data/Foods/foods_semantic_matrix.csv'
# frequencypath =  'data/Foods/foods_frequency.csv'
# phonpath = 'data/Foods/foods_phonological_matrix.csv'

similaritypath =  'data/Occupations/occupations_semantic_matrix.csv'
frequencypath =  'data/Occupations/occupations_frequency.csv'
phonpath = 'data/Occupations/occupations_phonological_matrix.csv'
...
# python run_foraging.py --data /Users/mkang2/Library/CloudStorage/OneDrive-BowdoinCollege/Desktop/forager.txt --model all --switch all